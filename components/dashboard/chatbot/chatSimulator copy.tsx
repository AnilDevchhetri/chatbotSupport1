...
const ChatSimulator = ({
    ...
    return (
        <Card className='flex-1 flex flex-col border-white/5 bg-[#0A0A0E] overflow-hidden relative shadow-2xl min-h-0'>
            <div className='h-14 border-b borde-white/5 flex items-center justify-between px-6 bg-[#0E0E12]'>
                <div className='flex items-center gap-2'>
                    <div className='w-2 h-2 rounded-full bg-emerald-500 animate-pulse'></div>
                    <span className='text-sm font-medium text-zinc-300'>test</span>
                </div>
                                        ...
                                        <div className='flex flex-wrap gap-2 pt-2 ml-1 animate-in fade-in slide-in-from-top-1 duration-300'>
                                            {
                                                sections.map((section) => (
                                                    <button
                                                        ...
                                                        className='px-3 py-1.5 text-white rounded-full border border-zinc-500'
                                                    >
                                                        {section.name}
                                                    </button>
                                                ))
                        ...
                        <div className='flex w-full justify-start'>
                            <div className='flex max-w-[80%] gap-3 flex-row'>
                                <div
                                    ...
                                    style={{ backgroundClip: primaryColor }}
                                >
                                    <Bot className='w-4 h-4 text-white' />
                                </div>
                                <div className='p-4 rounded-2xl bg-wihte text-zinc-900 rounded-tl-sm shadow-sm flex itmes-center gap-1'>
                                    <div className='w-1.5 h-1.5 bg-zinc-400 rounded-full animate-bounce [animage-delay:-0.3s]' />
                                    <div className='w-1.5 h-1.5 bg-zinc-400 rounded-full animate-bounce [animage-delay:-0.15s]' />
            ...
            <div className='p-4 bg-[#0A0A0E] border-t border-white/5'>
                <div className='relative'>
                    <Textarea
                        ...
                        className='min-h-12.5 max-h-37.5 pr-12 outline-none text-white bg-zinc-900/50 border-white/10 resize-none rounded-xl 
  placeholder:text-zinc-400 disabled:opacity-50 disabled:cursor-not-allowed'
                    ...
                    <Button
                        ...
                        className={
                            cn("absolute right-2 bottom-2 h-8 w-8 transition-colors",
                                !activeSection || !input.trim() ? "bg-zinc-800 text-zinc-500" : "text-white"
                            )
                        }
                        style={
